...
export default function SectionPlaceholder({ label }) {
  return (
    <section className="section-block section-placeholder empty-hero w-max" aria-labelledby="placeholder-title" style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '60vh', textAlign: 'center', margin: '0 auto', maxWidth: '800px' }}>
